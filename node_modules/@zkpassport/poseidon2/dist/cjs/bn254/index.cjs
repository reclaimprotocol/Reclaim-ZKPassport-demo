...
// src/bn254/index.ts
var bn254_exports = {};
__export(bn254_exports, {
  F: () => F3,
  permute: () => permute3,
  poseidon2Hash: () => hashToField,
  poseidon2HashAsync: () => hashToFieldAsync
});
module.exports = __toCommonJS(bn254_exports);
...
// src/bn254/instance.ts
var bn254Field = new F1Field(
...
var FieldSponge = class _FieldSponge {
  ...
  absorb(input) {
    if (this.mode === 0 /* ABSORB */ && this.cacheSize === this.rate) {
      this.performDuplex();
      this.cache[0] = input;
      this.cacheSize = 1;
    } else if (this.mode === 0 /* ABSORB */ && this.cacheSize < this.rate) {
      this.cache[this.cacheSize] = input;
      this.cacheSize += 1;
    } else if (this.mode === 1 /* SQUEEZE */) {
      this.cache[0] = input;
      this.cacheSize = 1;
      this.mode = 0 /* ABSORB */;
    }
  ...
  squeeze() {
    if (this.mode === 1 /* SQUEEZE */ && this.cacheSize === 0) {
      this.mode = 0 /* ABSORB */;
      this.cacheSize = 0;
    }
    if (this.mode === 0 /* ABSORB */) {
...
async function hashToFieldAsync(input) {
  return (await FieldSponge2.hashFixedLength(input))[0];
}
