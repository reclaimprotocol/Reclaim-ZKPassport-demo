import { SortedNonMembershipProof } from '../../merkle-tree/async-ordered-mt.js';

type SanctionsInclusionProof = {
    leaf: string;
    leaf_index: string;
    sibling_path: string[];
};
type CircuitSanctionsProof = {
    left: SanctionsInclusionProof;
    right: SanctionsInclusionProof;
};
type SanctionsProofs = {
...
type SanctionsOrderedMerkleTreeProofs = {
...
export type { CircuitSanctionsProof, SanctionsInclusionProof, SanctionsOrderedMerkleTreeProofs, SanctionsProofs };
