...
var merkle_tree_exports = {};
__export(merkle_tree_exports, {
  AsyncIMT: () => AsyncIMT,
  AsyncOrderedMT: () => AsyncOrderedMT,
  computeMerkleProof: () => computeMerkleProof,
  poseidon2: () => poseidon2
});
module.exports = __toCommonJS(merkle_tree_exports);
var import_poseidon211 = require("@zkpassport/poseidon2");

// src/utils.ts
var import_utils13 = require("@zk-kit/utils");
...
var import_utils15 = require("@zk-kit/utils");
var AsyncIMT = class _AsyncIMT {
  ...
  constructor(hash, depth, arity = 2) {
    (0, import_utils15.requireFunction)(hash, "hash");
    (0, import_utils15.requireNumber)(depth, "depth");
    (0, import_utils15.requireNumber)(arity, "arity");
    this._hash = hash;
    this._depth = depth;
    this._zeroes = [];
    this._nodes = [];
   ...
   */
  indexOf(leaf) {
    (0, import_utils15.requireTypes)(leaf, "leaf", ["number", "string", "bigint"]);
    return this._nodes[0].indexOf(leaf);
  }
  async initialize(zeroValue, leaves = []) {
    (0, import_utils15.requireTypes)(zeroValue, "zeroValue", ["number", "string", "bigint"]);
    (0, import_utils15.requireObject)(leaves, "leaves");
  ...
  async update(index, newLeaf) {
    (0, import_utils15.requireNumber)(index, "index");
  ...
  static async verifyProof(proof, hash) {
    (0, import_utils15.requireObject)(proof, "proof");
    (0, import_utils15.requireTypes)(proof.root, "proof.root", ["number", "string", "bigint"]);
    (0, import_utils15.requireTypes)(proof.leaf, "proof.leaf", ["number", "string", "bigint"]);
    (0, import_utils15.requireArray)(proof.siblings, "proof.siblings");
    (0, import_utils15.requireArray)(proof.pathIndices, "proof.pathIndices");
    let node = proof.leaf;
...
async function poseidon2(values) {
  return (0, import_poseidon211.poseidon2HashAsync)(values.map((v) => BigInt(v)));
}
