...
var async_imt_exports = {};
__export(async_imt_exports, {
  AsyncIMT: () => AsyncIMT
});
module.exports = __toCommonJS(async_imt_exports);
...
var AsyncIMT = class _AsyncIMT {
  ...
  constructor(hash, depth, arity = 2) {
    (0, import_utils.requireFunction)(hash, "hash");
    (0, import_utils.requireNumber)(depth, "depth");
    (0, import_utils.requireNumber)(arity, "arity");
    this._hash = hash;
    this._depth = depth;
    this._zeroes = [];
    this._nodes = [];
   ...
   */
  indexOf(leaf) {
    (0, import_utils.requireTypes)(leaf, "leaf", ["number", "string", "bigint"]);
    return this._nodes[0].indexOf(leaf);
  }
  async initialize(zeroValue, leaves = []) {
    (0, import_utils.requireTypes)(zeroValue, "zeroValue", ["number", "string", "bigint"]);
    (0, import_utils.requireObject)(leaves, "leaves");
  ...
  async update(index, newLeaf) {
    (0, import_utils.requireNumber)(index, "index");
  ...
  static async verifyProof(proof, hash) {
    (0, import_utils.requireObject)(proof, "proof");
    (0, import_utils.requireTypes)(proof.root, "proof.root", ["number", "string", "bigint"]);
    (0, import_utils.requireTypes)(proof.leaf, "proof.leaf", ["number", "string", "bigint"]);
    (0, import_utils.requireArray)(proof.siblings, "proof.siblings");
    (0, import_utils.requireArray)(proof.pathIndices, "proof.pathIndices");
    let node = proof.leaf;
