...
// src/passport/sod.ts
var sod_exports = {};
__export(sod_exports, {
  DataGroupHashValues: () => DataGroupHashValues,
  SOD: () => SOD
});
module.exports = __toCommonJS(sod_exports);
...
var DSC = class _DSC {
  ...
  static fromDER(der) {
    ...
    const certificate = import_asn1_schema7.AsnParser.parse(der.toUInt8Array(), import_asn1_x5095.Certificate);
  ...
  static fromCertificate(certificate) {
    ...
    return {
      tbs: {
        bytes: Binary.from(import_asn1_schema7.AsnSerializer.serialize(tbs)),
        version: tbs.version,
...
var SOD = class _SOD {
  ...
  static fromDER(der) {
    der = der.slice(0, 2).equals(Binary.from([119, 130])) ? der.slice(4) : der;
    const contentInfo = import_asn1_schema8.AsnParser.parse(der.toUInt8Array(), import_asn1_cms4.ContentInfo);
    const signedData = import_asn1_schema8.AsnParser.parse(contentInfo.content, import_asn1_cms4.SignedData);
    if (!signedData.encapContentInfo?.eContent?.single) throw new Error("No eContent found");
    const eContent = import_asn1_schema8.AsnConvert.parse(
    ...
    const signingTime = signingTimeAttr ? import_asn1_schema8.AsnParser.parse(signingTimeAttr.toUInt8Array(), import_asn1_x5092.Time).getTime() : void 0;
    const signedAttrs = {
      bytes: Binary.from(import_asn1_schema8.AsnSerializer.serialize(reconstructedSignedAttrs)),
