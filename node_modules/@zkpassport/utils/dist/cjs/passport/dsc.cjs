...
// src/passport/dsc.ts
var dsc_exports = {};
__export(dsc_exports, {
  DSC: () => DSC
});
module.exports = __toCommonJS(dsc_exports);
...
var DSC = class _DSC {
  ...
  static fromDER(der) {
    ...
    const certificate = import_asn1_schema8.AsnParser.parse(der.toUInt8Array(), import_asn1_x5095.Certificate);
  ...
  static fromCertificate(certificate) {
    ...
    return {
      tbs: {
        bytes: Binary.from(import_asn1_schema8.AsnSerializer.serialize(tbs)),
        version: tbs.version,
