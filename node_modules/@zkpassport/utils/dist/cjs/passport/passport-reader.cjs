...
var passport_reader_exports = {};
__export(passport_reader_exports, {
  PassportReader: () => PassportReader,
  extractTBS: () => extractTBS,
  getDSCSignatureAlgorithmType: () => getDSCSignatureAlgorithmType,
  getDSCSignatureHashAlgorithm: () => getDSCSignatureHashAlgorithm,
  getEContent: () => getEContent,
  getEContentHashAlgorithm: () => getEContentHashAlgorithm,
  getSODCMSVersion: () => getSODCMSVersion,
  getSODContent: () => getSODContent,
  getSignedAttributesHashingAlgorithm: () => getSignedAttributesHashingAlgorithm,
  getSodSignatureAlgorithmType: () => getSodSignatureAlgorithmType,
  getSodSignatureHashAlgorithm: () => getSodSignatureHashAlgorithm
});
module.exports = __toCommonJS(passport_reader_exports);
...
var AttributeSet = class extends import_asn1_schema.AsnArray {
  constructor(items) {
    super(items);
...
AttributeSet = __decorateClass([
  (0, import_asn1_schema.AsnType)({ type: import_asn1_schema.AsnTypeTypes.Set, itemType: import_asn1_cms.Attribute })
], AttributeSet);
...
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: import_asn1_schema.AsnPropTypes.Integer })
], DataGroupHash.prototype, "number", 2);
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: import_asn1_schema.AsnPropTypes.OctetString })
...
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: import_asn1_schema.AsnPropTypes.PrintableString })
...
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: import_asn1_schema.AsnPropTypes.ObjectIdentifier })
], LDSSecurityObjectIdentifier.prototype, "value", 2);
LDSSecurityObjectIdentifier = __decorateClass([
  (0, import_asn1_schema.AsnType)({ type: import_asn1_schema.AsnTypeTypes.Choice })
...
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: import_asn1_cms.DigestAlgorithmIdentifier })
], LDSSecurityObject.prototype, "hashAlgorithm", 2);
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: DataGroupHash, repeated: "sequence" })
], LDSSecurityObject.prototype, "dataGroups", 2);
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: LDSVersionInfo, optional: true })
...
__decorateClass([
  (0, import_asn1_schema.AsnProp)({ type: import_asn1_x509.Certificate, repeated: "set" })
], MasterList.prototype, "certificates", 2);
MasterList = __decorateClass([
  (0, import_asn1_schema.AsnType)({ type: import_asn1_schema.AsnTypeTypes.Sequence })
], MasterList);
...
// src/utils.ts
var import_utils2 = require("@zk-kit/utils");
...
function getRSAPSSParams(parameters) {
  const parsedKey = import_asn1_schema3.AsnParser.parse(parameters, import_asn1_rsa.RsaSaPssParams);
...
var import_utils10 = require("@zk-kit/utils");
...
var DSC = class _DSC {
  ...
  static fromDER(der) {
    ...
    const certificate = import_asn1_schema6.AsnParser.parse(der.toUInt8Array(), import_asn1_x5095.Certificate);
  ...
  static fromCertificate(certificate) {
    ...
    return {
      tbs: {
        bytes: Binary.from(import_asn1_schema6.AsnSerializer.serialize(tbs)),
        version: tbs.version,
...
var SOD = class _SOD {
  ...
  static fromDER(der) {
    der = der.slice(0, 2).equals(Binary.from([119, 130])) ? der.slice(4) : der;
    const contentInfo = import_asn1_schema7.AsnParser.parse(der.toUInt8Array(), import_asn1_cms3.ContentInfo);
    const signedData = import_asn1_schema7.AsnParser.parse(contentInfo.content, import_asn1_cms3.SignedData);
    if (!signedData.encapContentInfo?.eContent?.single) throw new Error("No eContent found");
    const eContent = import_asn1_schema7.AsnConvert.parse(
    ...
    const signingTime = signingTimeAttr ? import_asn1_schema7.AsnParser.parse(signingTimeAttr.toUInt8Array(), import_asn1_x5092.Time).getTime() : void 0;
    const signedAttrs = {
      bytes: Binary.from(import_asn1_schema7.AsnSerializer.serialize(reconstructedSignedAttrs)),
...
function getSODContent(passport) {
  const cert = import_asn1_schema8.AsnParser.parse(passport.sod.bytes.toBuffer(), import_asn1_cms4.ContentInfo);
  const signedData = import_asn1_schema8.AsnParser.parse(cert.content, import_asn1_cms4.SignedData);
  return signedData;
}
