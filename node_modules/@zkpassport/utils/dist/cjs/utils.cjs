...
__export(utils_exports, {
  ...
  formatQueryResultDates: () => formatQueryResultDates,
  fromArrayBufferToBigInt: () => fromArrayBufferToBigInt,
  fromBytesToBigInt: () => fromBytesToBigInt,
  fromHex: () => fromHex,
  getBitSize: () => getBitSize,
  getChainDisplayName: () => getChainDisplayName,
  getChainFromId: () => getChainFromId,
  getHashAlgorithmIdentifierFromLength: () => getHashAlgorithmIdentifierFromLength,
  getIdFromChain: () => getIdFromChain,
  getNowTimestamp: () => getNowTimestamp,
  getOffsetInArray: () => getOffsetInArray,
  getTodayTimestamp: () => getTodayTimestamp,
  getUnixTimestamp: () => getUnixTimestamp,
  leftPadArrayWithZeros: () => leftPadArrayWithZeros,
  loadModule: () => loadModule,
  normaliseHex: () => normaliseHex,
  numberToBytesBE: () => numberToBytesBE,
  packBeBytesIntoField: () => packBeBytesIntoField,
  packBeBytesIntoFields: () => packBeBytesIntoFields,
  packLeBytesIntoFields: () => packLeBytesIntoFields,
  rightPadArrayWithZeros: () => rightPadArrayWithZeros,
  rightPadCountryCodeArray: () => rightPadCountryCodeArray,
  stringToAsciiStringArray: () => stringToAsciiStringArray,
  strip0x: () => strip0x,
...
var import_utils7 = require("@zk-kit/utils");
...
// src/utils.ts
async function loadModule(module2) {
  try {
...
function bigintToBytes(value) {
  return Array.from((0, import_utils15.bigIntToBuffer)(value));
}
...
function numberToBytesBE(n, len) {
  return (0, import_utils16.hexToBytes)(n.toString(16).padStart(len * 2, "0"));
}
