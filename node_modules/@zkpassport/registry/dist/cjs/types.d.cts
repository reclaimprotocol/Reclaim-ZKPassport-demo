import { PackagedCertificate } from '@zkpassport/utils/types';
...
interface PackagedCertificatesFile {
    certificates: PackagedCertificate[];
    serialised: any[];
}

export type { PackagedCertificatesFile, RegistryClientOptions, RootDetails };
