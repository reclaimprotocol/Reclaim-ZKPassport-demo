import { KeyPair } from './encryption.cjs';
import { WebSocketClient } from './websocket.cjs';
 ...
 */
declare class BridgeConnection {
    private log;
    private role;
    private origin?;
    private _bridgeOrigin?;
    private bridgeId;
    readonly keyPair: KeyPair;
    private remotePublicKey?;
    private sharedSecret?;
    private websocket?;
    private secureChannelEstablished;
     ...
     */
    createEncryptedGreeting(): Promise<string>;
    /**
     ...
     */
    _getWsConnectionUrl(): Promise<string>;
    /**
     ...
     */
    getWebSocket(): WebSocketClient | undefined;
    /**
...
export { BridgeConnection, type BridgeEventCallback, BridgeEventType, type BridgeOptions };
