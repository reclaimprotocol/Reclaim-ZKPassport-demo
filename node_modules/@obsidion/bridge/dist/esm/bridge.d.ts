...
declare class Bridge {
     ...
     */
    static create(options?: CreateOptions): Promise<BridgeInterface>;
    /**
     ...
     * @returns A promise that resolves to a functional bridge interface
     */
    static join(uri: string, options?: JoinOptions): Promise<BridgeInterface>;
...
export { Bridge, type BridgeInterface, type CreateOptions, type JoinOptions };
