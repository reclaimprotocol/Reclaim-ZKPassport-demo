import {
  ...
  toRlp,
  transactionType
} from "./chunk-WIXVUF6I.js";
import {
  secp256k1
} from "./chunk-NXO2NZTS.js";
import {
...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-KCYEFX5D.js");
  const signature_ = (() => {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-KAQNCCVH.js").then((module) => module.WebSocket);
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=_esm-5NFCEXGQ.js.map
